                                ...
                                <div class="col-md-5 col-sm-12 col-xs-12 mb-md-0 mb-sm-5">
                                    <div class="detail-gallery">
                                        ...
                                        <div class="position-relative">
                                            <div class="product-image-slider">
                                                <figure class="border-radius-7">
                                                    <img src="{{ asset('template_user/') }}/assets/img/crv.jpg"
                                                        alt="product image" />
                                                </figure>
                                                <figure class="border-radius-7">
                                                    <img src="{{ asset('template_user/') }}/assets/img/crv.jpg"
                                        ...
                                        <div class="slider-nav-thumbnails">
                                            <div><img src="{{ asset('template_user/') }}/assets/img/crv.jpg"
                                    ...
                                    <div class="detail-info pr-30 pl-30">
                                        ...
                                        <div class="product-extra-link2">
                                            ...
                                            <a aria-label="Add To Wishlist" class="button btn-wishlist"
                                                href="wishlist.html"><i class="fi-rs-heart"></i>Ajukan Penawaran</a>
                                        </div>
                                        <div class="pro-share">
                                            <ul>
                                ...
                                <div class="col-lg-12">
                                    <form>
                                        <div class="form-group p-4">
                                            <label for="formControlRange">Simulasi Kredit</label>
                                            <label for="formControlRange">Simulasi Kredit</label>
                                            {{-- <input type="range" class="form-control-range" id="formControlRange"> --}}
                                            <input type="range" name="rangeInput" min="1000000" max="8000000"
...
@push('after-script')
    <!-- Slider Rrange  JS -->
    <script src="{{ asset('template_user/') }}/assets/plugins/range-slider/slider-range.js"></script>
    <script>
        function updateTextInput(val) {
            document.getElementById('textInput').value = rupiah(val);
        }
        const rupiah = (number) => {
