                    ...
                    <div class="mt-5">
                        <div class="intro-y">
                            <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                    <img alt="OmegaMotors - HTML Admin Template"
                                        src="{{ asset('template_admin/') }}/dist/images/profile-1.jpg">
                                </div>
                                <div class="ml-4 mr-auto">
                                    <div class="font-medium">Brad Pitt</div>
                                    <div class="text-slate-500 text-xs mt-0.5">16 April 2021</div>
                                </div>
                                <div
                        ...
                        <div class="intro-y">
                            <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                    <img alt="OmegaMotors - HTML Admin Template"
                                        src="{{ asset('template_admin/') }}/dist/images/profile-2.jpg">
                                </div>
                                <div class="ml-4 mr-auto">
                                    <div class="font-medium">Al Pacino</div>
                                    <div class="text-slate-500 text-xs mt-0.5">14 June 2021</div>
                                </div>
                                <div
                                    class="py-1 px-2 rounded-full text-xs bg-success text-white cursor-pointer font-medium">
                                    137 Sales</div>
                        ...
                        <div class="intro-y">
                            <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                    <img alt="OmegaMotors - HTML Admin Template"
                                        src="{{ asset('template_admin/') }}/dist/images/profile-3.jpg">
                                </div>
                                <div class="ml-4 mr-auto">
                                    <div class="font-medium">Russell Crowe</div>
                                    <div class="text-slate-500 text-xs mt-0.5">18 November 2022</div>
                                </div>
                                <div
                                    class="py-1 px-2 rounded-full text-xs bg-success text-white cursor-pointer font-medium">
                                    137 Sales</div>
                        ...
                        <div class="intro-y">
                            <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                    <img alt="OmegaMotors - HTML Admin Template"
                                        src="{{ asset('template_admin/') }}/dist/images/profile-12.jpg">
                                </div>
                                <div class="ml-4 mr-auto">
                                    <div class="font-medium">Robert De Niro</div>
                                    <div class="text-slate-500 text-xs mt-0.5">4 October 2022</div>
                                </div>
                                <div
                                    class="py-1 px-2 rounded-full text-xs bg-success text-white cursor-pointer font-medium">
                                    137 Sales</div>
                                    ...
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="OmegaMotors - HTML Admin Template" class="tooltip rounded-full"
                                                    src="{{ asset('template_admin/') }}/dist/images/preview-13.jpg"
                                                    title="Uploaded at 16 April 2021">
                                            </div>
                                            ...
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="OmegaMotors - HTML Admin Template" class="tooltip rounded-full"
                                                    src="{{ asset('template_admin/') }}/dist/images/preview-12.jpg"
                                ...
                                <tr class="intro-x">
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="OmegaMotors - HTML Admin Template" class="tooltip rounded-full"
                                                    src="{{ asset('template_admin/') }}/dist/images/preview-7.jpg"
                                                    title="Uploaded at 14 June 2021">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="OmegaMotors - HTML Admin Template" class="tooltip rounded-full"
                                                    src="{{ asset('template_admin/') }}/dist/images/preview-1.jpg"
                                                    title="Uploaded at 13 October 2022">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="OmegaMotors - HTML Admin Template" class="tooltip rounded-full"
                                                    src="{{ asset('template_admin/') }}/dist/images/preview-1.jpg"
                                                    title="Uploaded at 6 February 2021">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr class="intro-x">
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="OmegaMotors - HTML Admin Template" class="tooltip rounded-full"
                                                    src="dist/images/preview-12.jpg" title="Uploaded at 18 November 2022">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="OmegaMotors - HTML Admin Template" class="tooltip rounded-full"
                                                    src="dist/images/preview-10.jpg" title="Uploaded at 7 March 2022">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="OmegaMotors - HTML Admin Template" class="tooltip rounded-full"
                                                    src="dist/images/preview-4.jpg" title="Uploaded at 5 April 2021">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr class="intro-x">
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="OmegaMotors - HTML Admin Template" class="tooltip rounded-full"
                                                    src="dist/images/preview-8.jpg" title="Uploaded at 4 October 2022">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="OmegaMotors - HTML Admin Template" class="tooltip rounded-full"
                                                    src="dist/images/preview-4.jpg" title="Uploaded at 9 June 2021">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="OmegaMotors - HTML Admin Template" class="tooltip rounded-full"
                                                    src="dist/images/preview-4.jpg" title="Uploaded at 2 July 2022">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                        ...
                        <div class="mt-5">
                            ...
                            <div class="intro-x">
                                <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                    <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                        <img alt="OmegaMotors - HTML Admin Template"
                                            src="{{ asset('template_admin/') }}/dist/images/profile-15.jpg">
                                    </div>
                                    <div class="ml-4 mr-auto">
                                        <div class="font-medium">Al Pacino</div>
                                        <div class="text-slate-500 text-xs mt-0.5">29 April 2020</div>
                                    </div>
                        ...
                        <div
                            ...
                            <div class="intro-x relative flex items-center mb-3">
                                <div
                                    ...
                                    <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                        <img alt="OmegaMotors - HTML Admin Template"
                                            src="{{ asset('template_admin/') }}/dist/images/profile-7.jpg">
                                    </div>
                                </div>
                                        ...
                                        <div class="flex mt-2">
                                            <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Nike Air Max 270">
                                                <img alt="OmegaMotors - HTML Admin Template"
                                                    ...
                                                    src="{{ asset('template_admin/') }}/dist/images/preview-9.jpg">
                                            </div>
                                            <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Nike Air Max 270">
                                                <img alt="OmegaMotors - HTML Admin Template"
                                                    class="rounded-md border border-white"
                                                    src="{{ asset('template_admin/') }}/dist/images/preview-10.jpg">
                                            </div>
                                            <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Nike Tanjun">
                                                <img alt="OmegaMotors - HTML Admin Template"
                                                    class="rounded-md border border-white"
                                                    src="{{ asset('template_admin/') }}/dist/images/preview-14.jpg">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="intro-x relative flex items-center mb-3">
                                <div
                                    ...
                                    <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                        <img alt="OmegaMotors - HTML Admin Template"
                                            src="{{ asset('template_admin/') }}/dist/images/profile-5.jpg">
                                    </div>
                                </div>
                                <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                    <div class="flex items-center">
                                    ...
                                    <div class="text-slate-500 mt-1">Has changed <a class="text-primary"
                                            href="">Samsung Galaxy S20 Ultra</a> price and description
                                    </div>
                                </div>
                            </div>
                            <div class="intro-x relative flex items-center mb-3">
                                <div
                                    ...
                                    <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                        <img alt="OmegaMotors - HTML Admin Template"
                                            src="{{ asset('template_admin/') }}/dist/images/profile-4.jpg">
                                    </div>
                                </div>
                                <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                    <div class="flex items-center">
