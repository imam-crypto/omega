                    ...
                    <div class="preview">
                        <form method="post" enctype="multipart/form-data"
                            ...
                            <div>
                                ...
                                <input id="regular-form-1" name="vehicle_name" value="{{ $vehicle->vehicle_name }}"
                                    type="text" class="form-control" placeholder="Input text">
                            </div>
                            <div>
                                <label for="regular-form-1" class="form-label mt-2">Vehicle Name</label>
                                <input id="regular-form-1" name="vehicle_image" type="file" class="form-control"
                                    placeholder="Input text">
                            </div>
                            <div>
                                <img class="mt-2" src="{{ Storage::url($vehicle->vehicle_image) }}" alt=""
